...
public class Pref {
	...
	private HiddenPluginBoardButton [] hiddenPluginBoardButtons;
	private SwitcherView [] switcherViews;
	...
	public HiddenPluginBoardButton[] getHiddenPluginBoardButtons() {
		return hiddenPluginBoardButtons;
	}
	public void setHiddenPluginBoardButtons(HiddenPluginBoardButton[] hiddenPluginBoardButtons) {
		this.hiddenPluginBoardButtons = hiddenPluginBoardButtons;
	}
	public SwitcherView[] getSwitcherViews() {
		return switcherViews;
	}
	public void setSwitcherViews(SwitcherView[] switcherViews) {
